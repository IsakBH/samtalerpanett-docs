...
## Hvem er denne boken/dokumentasjonen for?
Den er laget for folk som vil bidra til Samtaler På Nett (meg og viggo) og vil lære hvordan det funker. Også for megselv slik at jeg kan lettere fikse ting som [reverse proxy](https://en.wikipedia.org/wiki/Reverse_proxy) hvis det plutselig sier pang og dreper segselv.
